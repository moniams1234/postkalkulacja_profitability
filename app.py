...
DEFAULT_MACHINE_RATES: dict[str, float] = {
    # Uzupełnij wartości zgodnie z aktualnym plikiem stawek, jeżeli chcesz
    # aby aplikacja startowała od pełnej tabeli bez uploadu pliku.
    "HP Indigo 7K Digital Press": 0.0,
    "HP Indigo 35K Digital Press": 0.0,
    "Heidelberg CX 104": 0.0,
}
