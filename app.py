...
# ════════════════════════════════════════════════════════════════════════════
    ...
    st.markdown(
        '<div class="card">Domyślne stawki Prepress są uzupełnione automatycznie. '
        'Możesz zmienić stawkę Digital/Offset, zmienić stawki per klient albo '
        'przywrócić dane domyślne przyciskiem poniżej.</div>',
        unsafe_allow_html=True,
    )
